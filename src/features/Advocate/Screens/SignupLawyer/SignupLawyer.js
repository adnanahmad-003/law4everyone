            ...
            {step === 1 && (
              ...
              <View style={{ marginTop: 50 ,height:620}}>
                <Text style={{
                        ...
                        fontWeight: "600",
                        color: "white",
                      }}>Upload Your Current Profile Picture</Text>
                <UploadProfile />
                <Text style={{
                        fontSize: 28,
                        textAlign: 'left',
              ...
              <View style={{ marginTop: 50 }}>
                ...
                <View>
                  ...
                  <FlatList
                    ...
                    style={{paddingVertical:10 , borderColor:'#fff',borderWidth:2,marginVertical:5}}
                    contentContainerStyle={{ flexDirection: 'row', flexWrap: 'wrap' }}
                    renderItem={({ item }) => (
                      <TouchableOpacity
                        onPress={() => handleRemoveExpertise(item)}
                        style={{marginHorizontal:6, backgroundColor: "#f0f0f0",
                        marginRight: 5,
                        marginBottom: 5,
